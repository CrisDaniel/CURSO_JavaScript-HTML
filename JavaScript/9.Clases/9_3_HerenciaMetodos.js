...
class Estudiante extends Persona{
    ...
    estudiar(){
        return super.presentarse() + ". Soy de " + this.grado + "° grado y estudio en el colegio " + this.colegio + ".";
    }
}
...
class Maestro extends Persona{
    ...
    enseñar(){
        return super.presentarse() + ". Enseño " + this.materia + " en el colegio " + this.colegio + ".";
    }
}
